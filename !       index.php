...
<header>
  <div style="background-color: #101a26; color: white; padding: 5px 20px; display: flex; justify-content: space-between; align-items: center;">
    ...
    <div>
      ...
      <a href="#" style="color: white; margin: 0 5px;"><i class="fab fa-whatsapp"></i></a>
    </div>
  </div>
  <div style="background-color: #fcb900; padding: 10px 20px; display: flex; justify-content: space-between; align-items: center;">
    <div style="display: flex; align-items: center;">
      <img src="logo.png" alt="TATSTROY" style="height: 50px; margin-right: 10px;">
    </div>
    <div style="display: flex; align-items: center; gap: 10px;">
      <a href="#login" style="color: black;"><i class="fa fa-sign-in-alt"></i> Login</a>
      <a href="#register" style="color: black;"><i class="fa fa-user-plus"></i> Register</a>
      <a href="#cart" style="color: black;"><i class="fa fa-shopping-cart"></i> Cart (?0.00)</a>
      <input type="text" placeholder="Поиск товаров..." style="padding: 5px;">
      <button style="background-color: #d9534f; color: white; border: none; padding: 5px 10px;">Поиск</button>
    </div>
  </div>
	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="container-fluid">	
			...
			<div class="navbar-header">
				...
				<a href="index.php" class="navbar-brand">TATSTROY</a>
			</div>
